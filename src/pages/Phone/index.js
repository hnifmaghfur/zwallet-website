                    ...
                    <div className="content-main">
                        ...
                        <div className="d-flex flex-column justify-content-center align-items-center">
                            <div className="notes bg-transparent">
                                ...
                                <input onFocus={() => setPhoneActive(true)} onBlur={() => setPhoneActive(false)} onChange={(e) => setPhone(e.target.value)} value={phone} maxLength={11} className="note bg-transparent" type="text" placeholder="Enter your phone number" />
                            </div>
